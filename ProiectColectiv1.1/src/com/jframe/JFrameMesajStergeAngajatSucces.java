...
public class JFrameMesajStergeAngajatSucces extends JFrame {
	...
	public JFrameMesajStergeAngajatSucces() {
		...
		JLabel lblNewLabel = new JLabel("Angajatul a fost sters cu succes!");
