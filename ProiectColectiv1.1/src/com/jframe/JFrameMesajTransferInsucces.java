...
public class JFrameMesajTransferInsucces extends JFrame {
	...
	public JFrameMesajTransferInsucces() {
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		RezolutieAplicatie ra = new RezolutieAplicatie();
		width = ra.getLungimeComponenta(28);
		...
		JLabel lblNewLabel = new JLabel("Transferul angajatului NU s-a realizat!");
