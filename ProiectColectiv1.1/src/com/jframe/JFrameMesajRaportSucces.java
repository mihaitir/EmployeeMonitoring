...
public class JFrameMesajRaportSucces extends JFrame {
	...
	public JFrameMesajRaportSucces() {
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		RezolutieAplicatie ra = new RezolutieAplicatie();
		width = ra.getLungimeComponenta(30);
		...
		JLabel lblNewLabel = new JLabel("Raportul in format PDF a fost generat cu succes!");
