...
public class JFrameMesajRaportTrimis extends JFrame {
	...
	public JFrameMesajRaportTrimis() {
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		RezolutieAplicatie ra = new RezolutieAplicatie();
		width = ra.getLungimeComponenta(34);
		...
		JLabel lblNewLabel = new JLabel("Raportul a fost trimis catre echipa tehnica!");
		lblNewLabel.setFont(new Font("Segoe UI Symbol", Font.PLAIN, ra.getLungimeComponenta(1)));
		lblNewLabel.setBounds((int)ra.getPozitieX(18, width),0, ra.getLungimeComponenta(70, width),
