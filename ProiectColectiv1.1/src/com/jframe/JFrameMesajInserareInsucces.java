...
public class JFrameMesajInserareInsucces extends JFrame {
	...
	public JFrameMesajInserareInsucces() {
		...
		JLabel lblNewLabel = new JLabel("Nu s-a putut insera!");
		lblNewLabel.setFont(new Font("Segoe UI Symbol", Font.PLAIN, ra.getLungimeComponenta(1)));
		lblNewLabel.setBounds((int)ra.getPozitieX(27, width),0, ra.getLungimeComponenta(70, width), 
				ra.getInaltimeComponenta(90, height));
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel1 = new JLabel();
		lblNewLabel1.setBounds(0,0, 
